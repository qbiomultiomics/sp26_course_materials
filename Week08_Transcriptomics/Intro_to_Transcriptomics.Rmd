...
Oh no! These row names don't look very informative. We know that the rows in *rna_genes* symbolize genes, so what should we set *rownames()* to? Which is better, *gene_name* or *gene_id*?
...
Save *rna_clinical* to your *analysis_data* directory.
